...
import { CartId, CartItemId, CartOwner, ProductId, UserId } from "@/core/domain/identity";
import { SupabaseCartRepository } from "@/core/infrastructure/cart/SupabaseCartRepository";
import { LocalStorageCartRepository } from "@/core/infrastructure/cart/LocalStorageCartRepository";
import CartMapper from "@/core/interface-adapters/mappers/cart-item.mapper";
import { Database } from "@/lib/supabase/database.types";
import UserMapper from "@/core/interface-adapters/mappers/user.mapper";
import { DefaultCartGateway } from "@/core/infrastructure/cart/CartGateway";
import { AddItemToCart } from "@/usecases/cart/AddItemToCart";
import { ProductIdMapper } from "@/core/interface-adapters/mappers/identity.mapper";
import { CreateCartItemDraft } from "@/usecases/cart/CreateCartItemDraft";
import { SupabaseInventoryRepository } from "@/core/infrastructure/inventory/SupabaseInventoryRepository";
