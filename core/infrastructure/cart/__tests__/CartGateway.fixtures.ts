...
import { CartId, CartItemId, ProductId } from "@/core/domain/identity"
...
export const mockItem1: CartItem = new CartItem(
    new CartItemId(1),
    new ProductId(1),
    "Product 1",
...
export const mockItem2: CartItem = new CartItem(
    new CartItemId(2),
    new ProductId(2),
    "Product 2",
...
export const mockItem3: CartItem = new CartItem(
    new CartItemId(3),
    new ProductId(3),
    "Product 3",
...
const authCartAddedItem = new CartItem(
    new CartItemId(4),
    new ProductId(4),
    "Product 4",
...
const localCartAddedItem = new CartItem(
    new CartItemId(8),
    localCartItemDraft.productId,
    localCartItemDraft.name,
    localCartItemDraft.brand,
    localCartItemDraft.price,
    new Quantity(8)
)