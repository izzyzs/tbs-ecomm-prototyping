import { LocalCartRepository, LocalCartStorageDTO } from "@/core/domain/repositories/cart/LocalCartRepository";
import { Cart } from "@/core/domain/cart/cart";
import { LocalStorageError } from "@/core/infrastructure/cart/Errors";
import { CartItem, CartItemDraft, CartItemNotFoundError } from "@/core/domain/cart/cart-item";
import { ProductId, CartItemId } from "@/core/domain/identity";
