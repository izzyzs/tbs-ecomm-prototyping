...
export declare const Constants: {
    readonly public: {
        readonly Enums: {
            readonly cart_status: readonly ["open", "completed"];
            readonly Fulfillment: readonly ["NDD", "SDD", "PU"];
            readonly Role: readonly ["ADMIN", "DRIVER", "FLOOR"];
            readonly Status: readonly ["CANCELLED", "PLACED", "READY_FOR_PICKUP", "ON_ROUTE", "COMPLETE"];
        };
    };
};
export {};
