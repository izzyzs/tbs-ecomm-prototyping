    ...
    return (
        <AccordionPrimitive.Header className="flex">
            <AccordionPrimitive.Trigger
                ...
                className={cn(
                    "focus-visible:border-ring focus-visible:ring-ring/50 flex flex-1 justify-between gap-4 rounded-md py-4  transition-all hover:underline focus-visible:ring-[3px]  [&[data-state=open]>svg]:rotate-180",
