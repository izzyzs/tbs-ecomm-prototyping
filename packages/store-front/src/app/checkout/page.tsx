                            ...
                            <div className="rounded-[1.75rem] border border-rose-200/70 bg-white/85 p-5 shadow-[0_20px_45px_-35px_rgba(15,23,42,0.55)]">
                                ...
                                <form action="" className="mt-5 grid gap-4">
                                    <div className="grid gap-2">
                                        ...
                                        <Input id={`address`} name={`address`} className="rounded-xl border-slate-200 bg-white/90"></Input>
                                    </div>
                                    ...
                                    <div className="grid gap-2">
                                        ...
                                        <Input id={`city`} name={`city`} className="rounded-xl border-slate-200 bg-white/90"></Input>
                                    </div>
                                    ...
                                    <div className="grid gap-2">
                                        ...
                                        <Input id={`state`} name={`state`} className="rounded-xl border-slate-200 bg-white/90"></Input>
                                    </div>
                                </form>
                            </div>
                        ) : fulfillment === "pickup" ? (
