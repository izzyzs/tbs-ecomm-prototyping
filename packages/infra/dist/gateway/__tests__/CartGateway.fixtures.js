...
export const mockItem1 = new CartItem(new CartItemId(1), new ProductId(1), "Product 1", "This is the first product", new Money(1000), new Quantity(1));
export const mockItem2 = new CartItem(new CartItemId(2), new ProductId(2), "Product 2", "This is the second product", new Money(2000), new Quantity(2));
export const mockItem3 = new CartItem(new CartItemId(3), new ProductId(3), "Product 3", "This is the third product", new Money(3000), new Quantity(3));
